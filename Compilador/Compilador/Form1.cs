...
namespace Compilador
{
    public partial class Form1 : Form
    {
        ...
        private void analiLex()
        {
                ...
                if (comentario == false)
                {
                    ...
                    else if (word == "(" | word == ")" | word == "{" | word == "}" | word == "};")
                    {
                        ...
                        else
                        {
                            ...
                            RIchTxLexico.Text = RIchTxLexico.Text + "cierre de agrupación principal lestgo: " + word + "\n";
                            tipo = "cierre lestgo";
                            AnalalisisSintactico(word, tipo);
                            traducir(word, tipo); sintactica(word, tipo); cierres(word, tipo); Repetir(word, tipo); escribir(word, tipo);
            ...
            {
                if (cierrelestgo == false)
                { //richErroresSintac.Text += "Error se esperaba }; cierre de lestgo\n"; 
                }
            ...
            if (lestgo == 1)
            {
                //richErroresSintac.Text += "No se encuentra la funcion principal lestgo\n";
            }
        ...
        void pintar()
        {
            ...
            {
                string modelo = "";
                string[] palabras = { "si", "solo", "se", "repetir", "@", "#", "lestgo", "hacer", "solo", "//", "MeedCompy" , "MeedMusic", "Meedot",
        ...
        void AnalalisisSintactico(string palabra, string tipo)
        {
            ...
            else
            {
                ...
                if (tipo == "apertura de llave") { llavesnecesarias = llavesnecesarias - 1; if (palabraanterior == "se" | palabraanterior == "lestgo" | palabraanterior == "hacer") { analisisSin.Text = "sin errores entre lestgo o hacer\n"; } else {// richErroresSintac.Text = "verifica no tener palabras entre lestgo o hacer y sus llaves\n";
                                                                                                                                                                                                                                                       } }
                ...
                if (tipo == "cierre lestgo") { cierrelestgo = true; }// una  vez se cerro el lestgo ya nada debe ser funcional
...
//                        richErroresSintac.Text += "antes de el cierre de parentesis debe haber una variable o un numero\n";
        ...
        void traducir(string palabra, string tipo)
        {
            ...
            if (palabra != "//" && palabra != "///")
            {
                ...
                if (palabra == "lestgo") { CCCode.Text += "#include <iostream>\nusing namespace std;\nint main()\n"; }
                if (palabra == "};") { CCCode.Text += "\nreturn 0 ;\n}"; }
        ...
        private void BTraducir_Click(object sender, EventArgs e)
        {
            CCCode.Text = "";
            Ccode.Text = "";
            amoc = false;
            ...
            foreach (string word in words)
            {
                ...
                if (word != "//" && word != "///")
                {
                    ...
                    if (amoact == true && commmm == false) { wo = "lestgo"; }
                    ...
                    switch (wo)
                    {
                        ...
                        case "lestgo":
                            amoact = true;
                            if (word == "lestgo" | amoc == true && cier == false && commmm == false)
                            {
                        ...
                        case "si":
                            ...
                            if (word != "lestgo" && commmm == false | word != "}" | word != "{" | word != "};" | word != "(" | word != ")" | word != "solo" | word != "hacer" | word != "si" | word != "se" | word != "repetir" | word != "," | word != "<<" | word != ">>" | word != "" | word != ":" | word != "//" | word != "///" | word != "++" | word != "==" && cier == false) { CCCode.Text += word; if (palabraanterior == "==") { siact = false; } }
                            else
                            if (word == "==" && commmm == false) { CCCode.Text += " == "; }
                            else
                        ...
                        case "repetir":
                                ...
                                if (word == ":" && commmm == false)
                            {
                                ...
                                if (word != "lestgo" && commmm == false | word != "}" | word != "{" | word != "};" | word != "(" | word != ")" | word != "solo" | word != "hacer" | word != "si" | word != "se" | word != "repetir" | word != "," | word != "<<" | word != ">>" | word != "" | word != ":" | word != "//" | word != "///" | word != "++" | word != "==")
                            {
